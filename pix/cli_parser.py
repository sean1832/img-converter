...
def get_parser():
    ...
    convert_parser.add_argument("output", type=str, help="Output image or directory (default: .)", default=".")
    ...
    convert_parser.add_argument("-o", "--overwrite", action="store_true", help="Overwrite existing files")
    convert_parser.add_argument("-t", "--transparent", action="store_true", help="Preserve transparency")
    ...
    resize_parser.add_argument("output", type=str, help="Output image or directory", default=".")
    resize_parser.add_argument("-o", "--overwrite", action="store_true", help="Overwrite existing files")
    ...
    crop_parser.add_argument("output", type=str, help="Output image or directory", default=".")
    crop_parser.add_argument("-o", "--overwrite", action="store_true", help="Overwrite existing files")
